...
public class DiaryDbAdapter {
	...
	public long createDiary(String title, String body) {
		...
		initialVal.put(KEY_TITLE, title);
		initialVal.put(KEY_BODY, body);
		Calendar cal = Calendar.getInstance();
		String created = cal.get(Calendar.YEAR) + "//"
				+ cal.get(Calendar.MONTH) + "//"
				+ cal.get(Calendar.DAY_OF_MONTH) + "  "
				+ cal.get(Calendar.HOUR_OF_DAY) + ":"
				+ cal.get(Calendar.MINUTE);
		initialVal.put(KEY_CREATED, created);
		return mDb.insert(DATABASE_TABLE, null, initialVal);
